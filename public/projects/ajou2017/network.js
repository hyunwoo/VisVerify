    ...
    if (!useGrad) {
        ...
        if (q.startsWith('q9')) {
            ...
            nodes = new vis.DataSet([
                ...
                {label: '음식점', id: '음식점', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 60},
                ...
                {label: '놀거리', id: '놀거리', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 20},

                {label: '깡통집', id: '깡통집', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 44},
                {label: '내찜닭', id: '내찜닭', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 25},
                {label: '맛이짱', id: '맛이짱', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 35},
                {label: '만고쿠', id: '만고쿠', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '푸드테라피', id: '푸드테라피', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '미스터쉐프', id: '미스터쉐프', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 50},
                {label: '시골집', id: '시골', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '태화장', id: '태화장', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '아맛집', id: '아맛집', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 30},
                {label: '윤씨부엌', id: '윤씨부엌', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '이모네손칼국수', id: '이모네손칼국수', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                {label: '알촌', id: '알촌', color: color[7], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                ...
                {label: '코인노래방', id: '코인노래방', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 15},
                {label: '광교호수공원', id: '광교호수공원', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                {label: '놀숲', id: '놀숲', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '고릴라 PC방', id: '고릴라 PC방', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 2},
                {label: '텔리토비 동산', id: '텔리토비 동산', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 3},])
        }
    }
