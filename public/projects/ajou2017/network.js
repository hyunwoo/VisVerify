...
function createNetworkData(q, color, useGrad) {
    ...
    if (!useGrad) {
        ...
        if (q.startsWith('q9')) {
            ...
            nodes = new vis.DataSet([
                {id: 'root', label: '추천하는 핫 플레이스', color: color[0], font: {color: 'inherit', face: 'Hanna'}, value: 70},
                {label: '음식점', id: '음식점', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 60},
                {label: '카페', id: '카페', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 55},
                {label: '술집', id: '술집', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '상점', id: '상점', color: color[3], font: {color: 'inherit', face: 'Hanna'}, value: 20},
                {label: '놀거리', id: '놀거리', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 20},

                {label: '깡통집', id: '깡통집', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 44},
                {label: '내찜닭', id: '내찜닭', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 25},
                {label: '맛이짱', id: '맛이짱', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 35},
                {label: '만고쿠', id: '만고쿠', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '푸드테라피', id: '푸드테라피', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '미스터쉐프', id: '미스터쉐프', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 50},
                {label: '시골집', id: '시골', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '태화장', id: '태화장', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '아맛집', id: '아맛집', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 30},
                {label: '윤씨부엌', id: '윤씨부엌', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '이모네손칼국수', id: '이모네손칼국수', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                {label: '알촌', id: '알촌', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 5},

                {label: '까페안녕', id: '까페안녕', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 20},
                {label: '굿커피', id: '굿커피', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 50},
                {label: '3Q', id: '3Q', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '스타벅스', id: '스타벅스', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '커피다움', id: '커피다움', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 2},
                {label: '키브한커피', id: '키브한커피', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                {label: '투썸플레이스', id: '투썸플레이스', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 7},
                {label: '키브한 커피', id: '키브한 커피', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '커볶수', id: '커볶수', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '탐앤탐스', id: '탐앤탐스', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: 'KAPPA COFFEE', id: 'KAPPA COFFEE', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 10},

                {label: '39포차', id: '39포차', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '오뎅바', id: '오뎅바', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 4},
                {label: '두메산골', id: '두메산골', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '렉스', id: '렉스', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 3},
                {label: '노군맥주', id: '노군맥주', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 30},
                {label: '온리유', id: '온리유', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 2},
                {label: '빨간석쇠구이', id: '빨간석쇠구이', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 38},
                {label: '아대돌곱창', id: '아대돌곱창', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 22},
                {label: '오뚜기', id: '오뚜기', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 35},
                {label: '아주캠프', id: '아주캠프', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 40},

                {label: '왓슨스', id: '왓슨스', color: color[3], font: {color: 'inherit', face: 'Hanna'}, value: 4},
                {label: '올리브영', id: '올리브영', color: color[3], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '부부웍스', id: '부부웍스', color: color[3], font: {color: 'inherit', face: 'Hanna'}, value: 6},

                {label: '코인노래방', id: '코인노래방', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 15},
                {label: '광교호수공원', id: '광교호수공원', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 5},
                {label: '놀숲', id: '놀숲', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 10},
                {label: '고릴라 PC방', id: '고릴라 PC방', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 2},
                {label: '텔리토비 동산', id: '텔리토비 동산', color: color[8], font: {color: 'inherit', face: 'Hanna'}, value: 3},])
        }else if(q.startsWith('q5')){
            edges = new vis.DataSet([
                {from: '교내 프로그램', to: 'root'},
                {from: '캠퍼스', to: 'root'},
                {from: '축제', to: 'root'},
                {from: '학생지원', to: 'root'},


                {from: 'After you', to: '교내 프로그램'},
                {from: '교환학생', to: '교내 프로그램'},
                {from: '국제화프로그램', to: '교내 프로그램'},
                {from: '파란학기제', to: '교내 프로그램'},
                {from: '푸드테라피', to: '교내 프로그램'},
                {from: '미스터쉐프', to: '교내 프로그램'},
                {from: '시골', to: '교내 프로그램'},
                {from: '태화장', to: '교내 프로그램'},
                {from: '아맛집', to: '교내 프로그램'},
                {from: '윤씨부엌', to: '교내 프로그램'},
                {from: '이모네손칼국수', to: '교내 프로그램'},
                {from: '알촌', to: '음식교내 프로그램점'},
            ...
            nodes = new vis.DataSet([
                {id: 'root', label: '아주대만이 가지고 있는 장점', color: color[0], font: {color: 'inherit', face: 'Hanna'}, value: 70},
                {label: '음식점', id: '교내 프로그램', color: color[4], font: {color: 'inherit', face: 'Hanna'}, value: 60},
                {label: '카페', id: '캠퍼스', color: color[5], font: {color: 'inherit', face: 'Hanna'}, value: 55},
                {label: '술집', id: '축제', color: color[2], font: {color: 'inherit', face: 'Hanna'}, value: 40},
                {label: '상점', id: '학생지원', color: color[3], font: {color: 'inherit', face: 'Hanna'}, value: 20},
