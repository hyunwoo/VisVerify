...
// /browser compatibility
    ...
    var Kmeans = function (observations, k, iter) {
        this._observations = observations;
        this._k = k || 3;
        this._iterations = []; // collection of iteration objects
        this._iter_count = iter;
    }
    ...
    Kmeans.prototype = {
        ...
        _generateClusters: function (means) {
            ...
            for (var i in this._observations) {
                ...
                if (this.nodes[cluster] === null || this.nodes[cluster] === undefined)
                    this.nodes[cluster] = [];
                this.nodes[cluster].push(i);
            }
            return clusters;
        }
        ,
    ...
    exports.create = function (data, k, iter) {
        if (iter === undefined) iter = 10;
        return new Kmeans(data, k, iter);
    }
